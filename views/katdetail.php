<?php
  ...
  <form class='like' method='post' action='index.php?pagina=$pagina'>
      <div  class='swipebuttons'>
      <input type='hidden' value='$kat->id' name='katid'>
      <input type='hidden' value='" . $_SESSION['gebruiker_id'] . "' name='gebruikerid'>
        <div class='likeopdetail'>
          <input type='submit' value='Vind deze kat leuk' name='like-kat'>
          <i class='likeicon'></i>
        </div>
      </div>
  </form>
